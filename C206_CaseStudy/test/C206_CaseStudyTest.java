...
public class C206_CaseStudyTest {
	...
	public void testRetrieveAllUser() {
		...
		testOutput = String.format("%-10s %-10d %-15s %-18s %-10s\n", "Danny", 1, "password001", "dan6@gmail.com",
				"Customer");
	...
	public void testRetrieveAllCurrency() {
		...
		// Test if the expected output string same as the list of currencies retrieved
	...
	public void testRetrieveAllTransactions() {
		...
		testOutput = String.format("%-20s %-20s %-20s %-20s %-20s %-20s %-20s %-20s %-20s\n", "Timmy", 10, "pass",
				"banana@gmail.com", "customer", 1, sDate1, 200, "SGD");
	...
	public void testRetrieveAllExchangeRates() {
		...
		// Test if the list of exchange rates retrieved from the ExchangeRateMain is
		// empty - boundary
		...
		// Test if the expected output string same as the list of exchange rates
		// retrieved from the ExchangeRateMain
		...
		// assertEquals("Test that ViewAllExchangeRatesList", testOutput,
		// allExchangeRates);
	}
